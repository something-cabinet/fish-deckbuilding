...
export const ZONES: ZoneDef[] = [
  {
    ...
    enemyPool: [
      ...
      { name: "Collection Agent", kind: UnitKind.Thug, hp: 3, atk: 1, move: 3, range: 2 },
      { name: "Informant", kind: UnitKind.Thug, hp: 4, atk: 2, move: 3, range: 2 },
    ],
    theme: "shallow",
  },
  {
    ...
    enemyPool: [
      ...
      { name: "Heavy", kind: UnitKind.Enforcer, hp: 12, atk: 3, move: 1 },
      { name: "Mob Nurse", kind: UnitKind.Enforcer, hp: 5, atk: 1, move: 2 },
      { name: "Informant", kind: UnitKind.Thug, hp: 5, atk: 3, move: 3, range: 2 },
      { name: "Caster", kind: UnitKind.Enforcer, hp: 5, atk: 1, move: 1, range: 3 },
    ],
    theme: "mid",
  },
  {
    ...
    enemyPool: [
      ...
      { name: "Heavy", kind: UnitKind.Enforcer, hp: 16, atk: 4, move: 1 },
      { name: "Mob Nurse", kind: UnitKind.Enforcer, hp: 7, atk: 2, move: 2 },
      { name: "Caster", kind: UnitKind.Enforcer, hp: 7, atk: 2, move: 1, range: 3 },
    ],
    theme: "deep",
  },
]
