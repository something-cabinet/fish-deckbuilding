...
export const ZONES: ZoneDef[] = [
  {
    ...
    enemyPool: [
      { name: "Soldier", kind: UnitKind.Soldier, hp: 4, atk: 2, move: 2 },
      { name: "Capo", kind: UnitKind.Capo, hp: 6, atk: 3, move: 2 },
  ...
  },
  {
    ...
    enemyPool: [
      { name: "Capo", kind: UnitKind.Capo, hp: 6, atk: 3, move: 2 },
      { name: "Soldier", kind: UnitKind.Soldier, hp: 7, atk: 3, move: 2 },
      { name: "Fixer", kind: UnitKind.Capo, hp: 7, atk: 3, move: 2 },
      { name: "Heavy", kind: UnitKind.Capo, hp: 12, atk: 3, move: 1 },
  ...
  },
  {
    ...
    enemyPool: [
      { name: "Capo", kind: UnitKind.Capo, hp: 9, atk: 4, move: 2 },
      { name: "Soldier", kind: UnitKind.Soldier, hp: 10, atk: 4, move: 2 },
      { name: "Loan Officer", kind: UnitKind.Capo, hp: 9, atk: 2, move: 1 },
