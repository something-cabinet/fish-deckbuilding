...
import { DEFAULT_SETTINGS } from "@/components/game/fish-mafia-app"

/* ------------------------------------------------------------------ */
/* jsdom shims                                                        */
/* ------------------------------------------------------------------ */

// 2D canvas context: jsdom returns null unless the `canvas` package is installed.
...
// Element.scrollTo: not implemented in jsdom.
