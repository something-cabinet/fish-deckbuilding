...
function unitByTeam(state: GameState, team: Team) {
...
describe("card parity: foreclose", () => {
  ...
  it("kills a 4 HP Thug, removes it via cleanupDead, logs death", () => {
    ...
    const deathFx = fx.find((e) => e.kind === FxKind.Death)
