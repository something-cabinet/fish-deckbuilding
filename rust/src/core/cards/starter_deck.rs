...
pub fn all_starter_cards() -> Vec<CardDef> {
    ...
    cards.push(CardDef::new("fin_slash", "Fin Slash", 1, vec![
        CardEffect { effect: Effect::Damage(3), range: 1, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("splash", "Splash", 0, vec![
        CardEffect { effect: Effect::Damage(1), range: 1, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("bubble_shield", "Bubble Shield", 1, vec![
        CardEffect { effect: Effect::Shield(4), range: 0, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("quick_swim", "Quick Swim", 1, vec![
        CardEffect { effect: Effect::DrawCards(2), range: 0, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("deep_breath", "Deep Breath", 0, vec![
        CardEffect { effect: Effect::Heal(2), range: 0, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("scale_throw", "Scale Throw", 1, vec![
        CardEffect { effect: Effect::Damage(2), range: 3, aoe: 1 },
    ], Common));
    cards.push(CardDef::new("tail_slap", "Tail Slap", 2, vec![
        CardEffect { effect: Effect::Damage(5), range: 1, aoe: 1 },
    ], Uncommon));
    cards.push(CardDef::new("ink_jet", "Ink Jet", 1, vec![
        CardEffect { effect: Effect::Damage(2), range: 2, aoe: 2 },
        CardEffect { effect: Effect::ApplyBuff(BuffType::Blind, 1), range: 2, aoe: 2 },
    ], Uncommon));
    cards.push(CardDef::new("coral_shell", "Coral Shell", 2, vec![
        CardEffect { effect: Effect::Shield(6), range: 0, aoe: 1 },
    ], Uncommon));
    cards.push(CardDef::new("healing_rain", "Healing Rain", 2, vec![
        CardEffect { effect: Effect::Heal(3), range: 2, aoe: 2 },
    ], Uncommon));
    cards.push(CardDef::new("tidal_wave", "Tidal Wave", 3, vec![
        CardEffect { effect: Effect::Damage(4), range: 3, aoe: 3 },
    ], Rare));
    cards.push(CardDef::new("sirens_call", "Siren's Call", 1, vec![
        CardEffect { effect: Effect::ApplyBuff(BuffType::Strengthen, 2), range: 0, aoe: 1 },
    ], Rare));
    cards.push(CardDef::new("desperate_strike", "Desperate Strike", 3, vec![
