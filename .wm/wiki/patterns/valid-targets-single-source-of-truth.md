...
3. The **AI** â€” to determine which targets are valid for enemy card play
4. The **engine** â€” to validate play decisions before resolving effects
...
## Related
- @wiki/core:critical-patterns (2026-07-27 â€” Test the UI Orchestration Layer)
